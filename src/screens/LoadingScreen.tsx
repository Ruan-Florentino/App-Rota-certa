...
import { PlaneIcon, WorldIcon, MapIcon, SparklesIcon, ExploreIcon } from "../components/icons";
      ...
      <div className="relative flex flex-col items-center w-full max-w-md">
        ...
        >
          ...
          <div className="w-32 h-32 glass-card rounded-[40px] flex items-center justify-center shadow-2xl border-white/10 relative z-10">
            ...
            >
              <PlaneIcon size={64} className="text-primary" strokeWidth={2} />
            </motion.div>
          </div>
          ...
          {[0, 1, 2].map((i) => (
            ...
            >
              <SparklesIcon
                size={16}
                className="text-accent absolute opacity-60"
                style={{
                  top: i * 30 + "%",
                  left: i * 20 + "%",
                }}
        ...
        <div className="mt-16 flex items-center gap-8 opacity-30">
          ...
          <ExploreIcon size={24} className="text-white" />
        </div>
      </div>
    </div>
  );
